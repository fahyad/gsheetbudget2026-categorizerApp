...
### Phase 32: Reports Tab (Apps Script v11.23)
- **Status:** code complete + syntax-clean. Awaiting `./apps-script/deploy.sh "v11.23 — reports tab"` + user runs `Update Script` to render the new tab.
